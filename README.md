...
[![codecov](https://codecov.io/gh/B08902060/fastapi-template/branch/main/graph/badge.svg?token=fastapi-template_token_here)](https://codecov.io/gh/B08902060/fastapi-template)
[![CI](https://github.com/B08902060/fastapi-template/actions/workflows/main.yml/badge.svg)](https://github.com/B08902060/fastapi-template/actions/workflows/main.yml)

Awesome fastapi_template created by B08902060

## Install

from source
```bash
git clone https://github.com/B08902060/fastapi-template fastapi_template
cd fastapi_template
make install
```
